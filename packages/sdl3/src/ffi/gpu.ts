...
export const sdlCopyGPUTextureToTexture = sdl3.func("void SDL_CopyGPUTextureToTexture(SDL_GPUCopyPass* copy_pass, _In_ const SDL_GPUTextureTransferInfo* source, _In_ const SDL_GPUTextureTransferInfo* destination, uint32 w, uint32 h, uint32 d, bool cycle)") as (copy_pass: GPUCopyPassPtr, source: GPUTextureTransferInfo, destination: GPUTextureTransferInfo, w: number, h: number, d: number, cycle: boolean) => void;
