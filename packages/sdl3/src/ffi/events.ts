...
export const sdlPumpEvents = sdl3.func(
    "void SDL_PumpEvents()",
) as () => void;
export const sdlHasEvent = sdl3.func(
    "bool SDL_HasEvent(uint32 type)",
) as (type: EventType) => boolean;
export const sdlHasEvents = sdl3.func(
    "bool SDL_HasEvents(uint32 minType, uint32 maxType)",
) as (minType: EventType, maxType: EventType) => boolean;
export const sdlFlushEvent = sdl3.func(
    "void SDL_FlushEvent(uint32 type)",
) as (type: EventType) => void;
export const sdlFlushEvents = sdl3.func(
    "void SDL_FlushEvents(uint32 minType, uint32 maxType)",
) as (minType: EventType, maxType: EventType) => void;
